...
def build_system_prompt() -> str:
    ...
    for name, info in CHARACTERS.items():
        ...
        if a >= 90:
            ...
            tone = "어느정도 아는 사이 20~30대 반존대. 친하지 않은 사람 대하듯."
        char_desc += f"\n### {name} ({info['role']})\n{info['personality']}\n현재 말투: {tone}\n"
...
4. 등장인물 대사는 반드시 앞뒤로 빈 줄을 넣어 단독 줄로 표기:
   ...
   "비가 내리는 날은 사람들이 가장 많이 상처받는 날이 아닌가 싶군."
...
■ 말투 변화 분기
- 0~29점: 20~30대 말투의 반존대, 거리감 있는 말투
...
- 한국어를 사용하지 못하는 경우, 시간이 걸려도 자체적으로 필터링해서 다시 한국어 사용할 수 있도록 시간 가져도 됨.

■ 절대 금지(반드시 기억, 발생할 시 자체 필터링 필수)

- 아래와 같은 한 문장안에 한국어와 한자어 혼용 절대 금지 
"그는 항상 주변的人들을 편안하게 해주는 능력이 있었다."
"정예진은 세 사람의 질문에 조금 혼乱한 듯 보였다. 하지만 그녀는 금방 정신을 차리고 대답했다."
